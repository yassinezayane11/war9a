...
function StatCard({ value, label, suffix = '', delay = 0 }) {
  ...
  return (
    <motion.div
      variants={fadeInUp}
      className="bg-dark-800/80 border border-dark-600 rounded-2xl p-6 text-center hover:border-brand-500/30 transition-all"
    >
      <div className="text-4xl font-bold text-brand-400 font-display mb-2">
...
function TicketPreviewCard({ ticket }) {
  ...
  return (
    <motion.div
      whileHover={{ y: -5 }}
      className="bg-dark-800 border border-dark-600 rounded-2xl p-5 hover:border-brand-500/30 transition-all"
    >
      ...
      <h3 className="font-display text-lg text-white mb-2">{ticket.title}</h3>
      <div className="flex items-center justify-between mb-3">
        <div className="text-brand-400 font-bold">{ticket.price} TND</div>
        {ticket.globalOdds && (
          <div className="text-green-400 font-mono text-sm">×{ticket.globalOdds}</div>
        )}
      </div>
      {firstMatchDate && (
...
function WinningTicketCard({ ticket }) {
  return (
    <motion.div
      ...
      className="gradient-border p-5 glow-green"
    >
      ...
      <h3 className="font-display text-xl text-white mb-2">{ticket.title}</h3>
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-dark-700 rounded-xl p-3 text-center">
          <div className="text-xs text-gray-500">Cote</div>
          <div className="text-green-400 font-bold">×{ticket.globalOdds}</div>
        </div>
        <div className="bg-dark-700 rounded-xl p-3 text-center">
          <div className="text-xs text-gray-500">Gain</div>
          <div className="text-brand-400 font-bold">{ticket.winningAmount} TND</div>
        </div>
      </div>
      {ticket.wonAt && (
    ...
    <div className="min-h-screen bg-dark-900">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-dark-900/80 backdrop-blur-lg border-b border-dark-600">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-brand-500 rounded-xl flex items-center justify-center text-white font-display text-xl">W</div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div>
              ...
              <motion.h1
                variants={fadeInUp}
                className="font-display text-5xl lg:text-6xl text-white leading-tight mb-6"
              >
                PRONOSTICS FOOTBALL
            ...
            <motion.div variants={fadeInUp} className="relative">
              {marketingImages.length > 0 ? (
                ...
                <div className="aspect-video bg-gradient-to-br from-brand-500/20 to-dark-800 rounded-2xl flex items-center justify-center border border-dark-600">
                  <div className="text-center">
                    <div className="text-6xl mb-4">🎯</div>
                    <div className="text-gray-400">Pronostics Premium</div>
                  </div>
                </div>
              )}
            </motion.div>
      ...
      {availableTickets.length > 0 && (
        <section className="py-20 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <h2 className="font-display text-3xl text-white mb-4">TICKETS DISPONIBLES</h2>
              <p className="text-gray-500">Achetez vos pronostics premium dès maintenant</p>
            </motion.div>
        ...
        <section className="py-20 px-6 bg-dark-800/30">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              className="text-center mb-12"
            >
              <h2 className="font-display text-3xl text-white mb-4">DERNIERS TICKETS GAGNANTS</h2>
              <p className="text-gray-500">Nos pronostics qui ont rapporté gros</p>
            </motion.div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              className="text-center mb-12"
            >
              <h2 className="font-display text-3xl text-white mb-4">AVIS DES GAGNANTS</h2>
              <p className="text-gray-500">Ce que disent nos clients satisfaits</p>
            </motion.div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-8">
              Rejoignez WAR9A.TN dès maintenant et accédez aux meilleurs pronostics football.
              Votre premier ticket vous attend!
            </p>
      ...
      <footer className="py-12 px-6 border-t border-dark-600">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="font-display text-lg text-white">WAR9A.TN</span>
              </div>
          ...
          <div className="border-t border-dark-600 pt-8 text-center text-gray-500 text-sm">
